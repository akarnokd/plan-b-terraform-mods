...
namespace UITranslationVietnamese
{
    [BepInPlugin("akarnokd.planbterraformmods.uitranslationvietnamese", PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class Plugin : BaseUnityPlugin
    {
        static ManualLogSource logger;

        static string languageId = "Vietnamese";
        static string englishName = "Vietnamese";
        static string localizedName = "Tiếng Việt";
        static string steamName = "vietnamese";
